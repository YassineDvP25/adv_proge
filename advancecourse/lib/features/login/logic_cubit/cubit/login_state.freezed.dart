...
mixin _$LoginState<T> {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_Loding<T> value) loding,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(_Loding<T> value)? loding,
...
abstract class _$$LodingImplCopyWith<T, $Res> {
  factory _$$LodingImplCopyWith(
    _$LodingImpl<T> value,
    $Res Function(_$LodingImpl<T>) then,
...
class __$$LodingImplCopyWithImpl<T, $Res>
  ...
  __$$LodingImplCopyWithImpl(
    _$LodingImpl<T> _value,
    $Res Function(_$LodingImpl<T>) _then,
  ) : super(_value, _then);
...
class _$LodingImpl<T> implements _Loding<T> {
  const _$LodingImpl();
...
abstract class _Loding<T> implements LoginState<T> {
  const factory _Loding() = _$LodingImpl<T>;
}
